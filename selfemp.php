...
---------------------------*/
if ($is_update) {
    mysqli_query($conn, "UPDATE goals SET goal_purpose='$goal', goal_amount='$goal_saving', savings_amount='$monthly_saving' WHERE user_id='$user_id' AND start_month='$current_month' AND start_year='$current_year'");
} else {
    mysqli_query($conn, "INSERT INTO goals (user_id, goal_purpose, goal_amount, savings_amount, start_month, start_year) VALUES ('$user_id', '$goal', '$goal_saving', '$monthly_saving', '$current_month', '$current_year')");
}
